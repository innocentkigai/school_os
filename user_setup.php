        ...
        <div class="register register-with-news-feed">
            ...
            <div class="news-feed">
                ...
                <div class="news-caption">
                    <h4 class="caption-title"><i class="fa fa-edit text-success"></i> School Operating System</h4>
                    <p>
                ...
                <div class="register-content">
                    <form action="index.html" method="POST" class="margin-bottom-0">
                        ...
                        <div class="row row-space-10">
                            <div id="first_name_div" class="col-md-4 m-b-15">
                                <input type="text" id="first_name"  class="form-control" placeholder="First name" required />
                            </div>
                            <div id="" class="col-md-4 m-b-15">
                                <input type="text"  id="last_name" class="form-control" placeholder="Middle name"/>
                            </div>                            
                            <div class="col-md-4 m-b-15">
                                <input type="text"  id="other_name" class="form-control" placeholder="Last name" required />
                            </div>
                        </div>
                        ...
                        <label class="control-label">County <span class="text-danger">*</span></label>
                        <div class="row m-b-15">
                            <div class="col-md-12">
                                <input type="password" class="form-control" placeholder="" required />
                            </div>
                        </div>
                        <label class="control-label">Sub County <span class="text-danger">*</span></label>
                        <div class="row m-b-15">
                            <div class="col-md-12">
                                <input type="password" class="form-control" placeholder="Password" required />
                            </div>
                        ...
                        <div class="register-buttons">
                            <button type="button" class="btn btn-primary btn-block btn-lg">Finish</button>
                        </div>
                        ...
                        <hr />
                        <p class="text-center">
                            &copy; School Operating System All Right Reserved 2017
                        </p>
                    </form>
                </div>
